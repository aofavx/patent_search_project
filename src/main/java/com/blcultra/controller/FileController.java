...
public class FileController extends BaseController{
     ...
     * @param usetype  1：评测时走BCC检索粗检      2：评测时走ES检索进行粗检
     * @return
     */
    ...
    public  String uploadExcel(@RequestData String uid,
        ...
        String res = fileService.uploadExcel(uid,file,checktype,usetype);
        return res;
    }
...
//    }
    ...
    public String getResultFile(HttpServletRequest request, HttpServletResponse response,
                                @RequestParam(value = "filename",defaultValue = "cn_zhuanli.csv") String filename){
        return fileService.getResultFile(request,response,filename);
    }
