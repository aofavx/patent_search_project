...
//                }
     ...
     */
    @Override
    public String uploadExcel(String uid, MultipartFile uploadfile,String checktype) {
...
//                    String kind = (String) sourceAsMap.get("kind");
    ...
    public String importReport(HttpServletRequest request, HttpServletResponse response, String uid, String pid) {
        ...
        //TODO:导出检索报告，参数定义
//        String pactUrl = "E:\\0PatentSearchProject\\patent-search\\src\\main\\resources\\file\\report-template.docx";
        Map<String,Object> param = new HashMap<>();
        param.put("applynum","ldkfajlfj12132324");
        param.put("applicanttime","20190822");
        param.put("applicant","王虎");
        param.put("applicantnum","20190822121314");
        param.put("keywords","高温 不锈钢 特质");

        List<Map<String,Object>> list = new ArrayList<>();
        Map<String,Object> map1 = new HashMap<>();
        map1.put("type","Y");
        map1.put("num","20198888411313211321");
        map1.put("date","2019-08-23");
        map1.put("classifycode","A01-05");

        Map<String,Object> map2 = new HashMap<>();
        map2.put("type","A");
        map2.put("num","20198888411313211321");
        map2.put("date","2019-08-23");
        map2.put("classifycode","A01-05");
        ...
        try {
            ...
            //查询出收藏列表信息，然后封装导出
            List<PatentCollectInfo> patents = patentCollectInfoMapper.selectCollectInfos(map);
